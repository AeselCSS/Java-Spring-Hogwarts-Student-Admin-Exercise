...
/**
 * This class is a custom exception that is thrown when a resource is not found in the application.
...
public class ResourceNotFoundException extends RuntimeException {
    ...
    /**
     * This constructor initializes a new instance of the ResourceNotFoundException class.
